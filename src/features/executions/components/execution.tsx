    ...
    return (
        <Card className="shadow-none">
            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <Link
                            ...
                            href={`/workflows/${execution.workflowId}`} prefetch>
                    ...
                    <div className="mt-6 bg-red-50 rounded-md space-y-3">
                        ...
                        {execution.errorStack && (
                            ...
                            >
                                ...
                                <CollapsibleContent>
                                    <pre className="text-sm text-red-900 font-mono mt-2 pt-2 overflow-auto bg:red-100 rounded">
                                        {execution.errorStack}
                                    </pre>
                                </CollapsibleContent>
                            </Collapsible>
                ...
                {execution.output && (
                    <div className="mt-6 bg-muted rounded">
