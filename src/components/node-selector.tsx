...
export function NodeSelector({
    ...
    const handleNodeSelect = useCallback((selection: NodeTypeOption) => {
        ...
        //check to ensure only one manual trigger
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            ...
            <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        A trigger is a step that starts a worlflow
                    </SheetDescription>
                </SheetHeader>
                <div>
                    {triggerNodes.map((nodeType) => {
                        ...
                        return (
                            <div
                                key={nodeType.type}
                                className="w-full justify-start h-auto py-5 px-4 rounded-none border-l-2
                                border-transparent hover:border-l-primary cursor-pointer"
